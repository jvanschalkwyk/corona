...
{ ALMY <- allo;
  ...
  myplot <- corona_annotate( myplot, MetTBL[,2:3], top=mTop, right=mRight, xmin=0.08, xmax=0.4, ymin=0.58, ymax=0.99);  
  myplot <- corona_annotate( myplot, MassTBL[,2:3], top=mTop, right=mRight, xmin=0.8, xmax=0.99, ymin=0.05, ymax=0.7);  
