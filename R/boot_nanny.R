...
#'
#'    Try ?corona for help. For most functions, saying pdf=TRUE will write PDF to images/. 
...
#' 
#' @param dir 'C:/nc' is default MS Windows directory; on Linux or Mac, is '~/nc' 
...
if( (.Platform$OS.type != 'windows')
  ...
  pth = './images/'; 
if(! dir.exists(pth) )
  { print( paste("WARNING! The directory", pth, "doesn't exist, PDF writes will fail.") );
  }; 
