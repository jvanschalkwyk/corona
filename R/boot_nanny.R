...
#'
#'    On loading, corona also loads ggplot2, gridExtra, plyr, qicharts2 
                           ...
                           legendx=0.155, legendy=0.85)
{
  p <- myplot + 
      theme(  plot.title=element_text(size=titlesize, face='bold'), 
        ...
        strip.text.x = element_text( margin = margin(0,0,0.2,0,'mm'), size=striptextsize )  
           ); 
  print(p); 
} 
...
#' 
#' For the book 'I Nanny Rona' (printing to PDF)
